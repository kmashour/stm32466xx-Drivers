...
g_pfnVectors:
/* .WORD DAH TA3RIF LY SMBOL BEL ASSEMBLY
    we kol elta3rifat deh MC specific
    etf2na en awl mkan fel vector table reserved lel stack we dah estack -> end of stack
    howa kda 7at fel mkan dah 7arfyan el end of stack fel linker symbol el esmo estack
    7lw talma howa linker symbol akid met3rf fel linker script
    ro7 ly debug folder stm32f446RETX_FLASH.Id
    el linker script motwak3 eno yekon malyan symbols zeryba men elsymbols */

    /*1-elstart up file howa ely 7at elvalue beta3t el end of stack fe location zero la2no 3arf
    elsymbol _estack fe awl location fel memory we el MP through hardware 5ad eladdress
    el fe location zero we 7atha fel sp*/
    /*2-we el3arf elvalue beta3t el end of stack howa el linker script*/
